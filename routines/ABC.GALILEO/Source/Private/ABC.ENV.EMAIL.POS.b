* @ValidationCode : MjotMTAwODk3NTkxNTpDcDEyNTI6MTc2OTI4NjMxMTI0OTpMdWlzIENhcHJhOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjI0X1NQMS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 24 Jan 2026 17:25:11
...
*-----------------------------------------------------------------------------
$PACKAGE AbcGalileo
SUBROUTINE ABC.ENV.EMAIL.POS
*===============================================================================
* Descripción:          Rutina que guarda informacion en la tabla ABC.SMS.EMAIL.ENVIAR para
* la notificacion de correo para TIPO.EMAIL: EMAIL.POS
*===============================================================================
*=============================================================================
...
*-----------------------------------------------------------------------------
    ...
    Y.TIENDA.DESC = EB.SystemTables.getRNew(AC.AccountOpening.LockedEvents.LckDescription)
