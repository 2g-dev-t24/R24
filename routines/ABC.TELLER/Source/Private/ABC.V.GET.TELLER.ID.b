...
*****change******Vane Feb. 2007********************************
    ...
    IF (EB.SystemTables.getPgmVersion() EQ ",ABC.2BR.CIERRE.AS") OR (EB.SystemTables.getPgmVersion() EQ ",ABC.2BR.CIERRE") OR (EB.SystemTables.getPgmVersion() EQ ",ABC.CIERRE") THEN
