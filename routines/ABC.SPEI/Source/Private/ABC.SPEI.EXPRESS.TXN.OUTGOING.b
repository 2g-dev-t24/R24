* @ValidationCode : MjotMzY3MTYzMjE2OkNwMTI1MjoxNzY3NjY5NDU4MzMwOkx1aXMgQ2FwcmE6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 06 Jan 2026 00:17:38
...
*-------------------------------------------------------------------------------
    ...
    IF R.ACCOUNT THEN
        ...
        AbcSpei.abcVCustomerName(Y.COMI, Y.NOM.ORDEN,MSG)
    END
