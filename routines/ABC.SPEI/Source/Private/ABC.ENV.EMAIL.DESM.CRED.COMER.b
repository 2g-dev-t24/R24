* @ValidationCode : MjoxMTA4MjQ2ODgyOkNwMTI1MjoxNzY3NjY4OTc3MDQ4Okx1aXMgQ2FwcmE6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 06 Jan 2026 00:09:37
...
SUBROUTINE ABC.ENV.EMAIL.DESM.CRED.COMER
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*    Y.CANAL.ENTIDAD = R.NEW(FT.LOCAL.REF)<1,POS.CANAL.ENTIDAD>
    ...
    Y.TIPO.EMAIL = "EMAIL.DESEM.CRED.COM"
