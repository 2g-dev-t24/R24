* @ValidationCode : MjotMTM4MTkwNzY0OkNwMTI1MjoxNzY3NjY4OTU1NTQxOkx1aXMgQ2FwcmE6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 06 Jan 2026 00:09:15
...
SUBROUTINE ABC.ENV.EMAIL.DESEM.CREDITO
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*    Y.CANAL.ENTIDAD = R.NEW(FT.LOCAL.REF)<1,POS.CANAL.ENTIDAD>
    ...
    Y.TIPO.EMAIL = "EMAIL.DESEM.CREDITO"
...
*    EB.DataAccess.Dbr('CUSTOMER':@FM:ST.Customer.Customer.EbCusEmailOne,Y.ID.CUS,Y.RESUL.EMAIL)
