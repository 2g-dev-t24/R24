* @ValidationCode : MjoxNzU4ODI0NjEyOkNwMTI1MjoxNzU1NDU2MTQ0NDgyOkx1aXMgQ2FwcmE6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 17 Aug 2025 15:42:24
...
SUBROUTINE ABC.MONTO.IVA.BONIFICACION
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*-------------------------------------------------------------------------------
    ...
    Y.TRANSACTION.TYPE = ''
    Y.ID.PARAM = 'ABC.UALA.BONIFICA.IVA.PARAM'
...
FINALLY:
*-------------------------------------------------------------------------------
    Y.VALOR = 'MONTO:':Y.MONTO:' IVA:':Y.MONTO.IVA
    EB.SystemTables.setRNew(FT.Contract.FundsTransfer.ExtendInfo,Y.VALOR)
