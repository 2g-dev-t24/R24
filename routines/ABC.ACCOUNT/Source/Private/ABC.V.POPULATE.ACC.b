* @ValidationCode : MjotMTA4NDg3MTM2NTpDcDEyNTI6MTc1Njk1MDU3NDYxOTpMdWNhc0ZlcnJhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 Sep 2025 22:49:34
...
*    Y.CUS.REF       = R.CUSREC<ST.Customer.Customer.EbCusLocalRef>
    ...
    Y.CLASSIFICATION    = Y.CLASSIFICATION[1,1]
    Y.TIPO.CTE          = Y.CLASSIFICATION

*    IF Y.TIPO.CTE EQ 1 OR Y.TIPO.CTE EQ 2 THEN
    IF Y.TIPO.CTE EQ 1 THEN
    ...
    END ELSE
        ETEXT = "CLIENTE " : Y.CUST.NO : " NO ES PERSONA FISICA, UTILICE ALTA DE CUENTAS PARA PERSONA MORAL "
