...
SUBROUTINE ABC.FILE.EXPORT
    $USING EB.SystemTables
    $USING EB.Template
    $USING AA.Framework
    $USING EB.Interface
*-----------------------------------------------------------------------------
    EB.Template.setTableName('ABC.FILE.EXPORT')       ;* Full application name including product prefix
    EB.Template.setTableTitle('Mapeos a exportar')   ;* Screen title
    ...
    EB.Template.setTableEquateprefix('FILE.EXP')          ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------
