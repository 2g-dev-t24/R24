...
SUBROUTINE ABC.IPAB.CRED.VENC
    $USING EB.SystemTables
    $USING EB.Template

*-----------------------------------------------------------------------------
    EB.Template.setTableName('ABC.IPAB.CRED.VENC')       ;* Full application name including product prefix
    EB.Template.setTableTitle('IPAB Creditos vencidos')   ;* Screen title
    ...
    EB.Template.setTableEquateprefix('IPAB.CRE.VEN')          ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------
