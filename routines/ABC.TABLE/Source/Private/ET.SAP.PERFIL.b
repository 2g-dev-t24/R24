...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
    EB.Template.setTableName('ET.SAP.PERFIL')       ;* Full application name including product prefix
    EB.Template.setTableTitle('Account Details')   ;* Screen title
    ...
    EB.Template.setTableEquateprefix('PFL')          ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------
