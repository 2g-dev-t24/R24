$PACKAGE AbcTable
SUBROUTINE ABC.CTAS.AUTORIZADAS.INT
*-----------------------------------------------------------------------------
    ...
    $USING EB.Interface
*-----------------------------------------------------------------------------
    EB.Template.setTableName('ABC.CTAS.AUTORIZADAS.INT')     ;* Full application name including product prefix
    ...
    EB.Template.setTableEquateprefix('VCAI')         ;* Use to create I_F.EB.LOG.PARAMETER
