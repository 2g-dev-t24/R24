...
SUBROUTINE ABC.PENDIENTES.GALILEO
...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
    EB.Template.setTableName('ABC.PENDIENTES.GALILEO')         ;* Full application name including product prefix
    EB.Template.setTableTitle('Aplicaciones Pendientes GAL')   ;* Screen title
    ...
    EB.Template.setTableEquateprefix('PEND.GALI')    ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------
