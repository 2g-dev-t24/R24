...
SUBROUTINE ABC.REP.R24.PARAM
    $USING EB.SystemTables
    $USING EB.Template
    $USING AA.Framework
    $USING EB.Interface
*-----------------------------------------------------------------------------
    EB.Template.setTableName('ABC.REP.R24.PARAM')       ;* Full application name including product prefix
    EB.Template.setTableTitle('ABC.REP.R24.PARAM')   ;* Screen title
    ...
    EB.Template.setTableEquateprefix('ARRP')          ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------
