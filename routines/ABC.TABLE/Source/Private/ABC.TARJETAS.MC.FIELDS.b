* @ValidationCode : MjoxNjM5MzU3MjAzOkNwMTI1MjoxNzU1NDQ0MzgxNzQzOkx1aXMgQ2FwcmE6LTE6LTE6MDowOnRydWU6Ti9BOlIyNF9TUDEuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 17 Aug 2025 12:26:21
...
*-----------------------------------------------------------------------------
    ...
    neighbour = ''
    EB.Template.TableAddfielddefinition(fieldName, fieldLength, fieldType, neighbour)
    EB.Template.FieldSetcheckfile ('ABC.PRODUCTOS.GALILEO':@FM:AbcTable.AbcProductosGalileo.NombreProd:@FM:'L.A')
