* @ValidationCode : MjotMTE3ODk0NDgyMzpDcDEyNTI6MTc2MTE3NDEzMjUxNjpMdWNhc0ZlcnJhcmk6LTE6LTE6MDowOnRydWU6Ti9BOlIyNF9TUDEuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Oct 2025 20:02:12
...
*-----------------------------------------------------------------------------
    ...
    EB.Template.TableAddoptionsfield   ("XX.PARENTESCO"         ,'PADRE_MADRE_HIJO(A)_ABUELO(A)_NIETO(A)_HERMANO(A)_TIO(A)_PRIMO(A)_SOBRINO(A)_ESPOSO(A)_SUEGRO(A)_CU?ADO(A)_AMIGO(A)_COMPADRE/COMADRE_MISMO CLIENTE_EMPRESA RELACIONADA_SOC EMP RELACIONADA', 'A', '')
    ...
    EB.Template.TableAddfielddefinition('XX<DEPO.APRX.CTA'      ,'3'        , 'A', '')
    EB.Template.TableAddoptionsfield   ('XX>DEPO.TIPO'          ,'Cheques_Efectivos_Trasferencia'   , 'A', '')

    EB.Template.TableAddfielddefinition('DEPO.MONTO.APRX'       ,'3'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.MONTO.MENSUAL")

    EB.Template.TableAddfielddefinition('XX<RETI.APRX.CTA'      ,'3'        , 'A', '')
    EB.Template.TableAddoptionsfield   ('XX>RETI.TIPO'          ,'Cheques_Efectivos_Trasferencia'   , 'A', '')
...
*  BENEFICIARIO                                                             *
*****************************************************************************
    EB.Template.TableAddfielddefinition('XX<BEN.APE.PATERNO'    ,'35'       , 'A', '')
    EB.Template.TableAddfielddefinition('XX-BEN.APE.MATERNO'    ,'35'       , 'A', '')
    EB.Template.TableAddfielddefinition('XX-BEN.NOMBRES'        ,'35'       , 'A', '')
    EB.Template.TableAddfielddefinition('XX-BEN.TELEFONO'       ,'10'       , 'A', '')
    EB.Template.TableAddfielddefinition('XX-BEN.PORCENTAJE'     ,'5'        , 'A', '')
    EB.Template.TableAddfielddefinition('XX-BEN.RFC'            ,'13'       , 'A', '')
    EB.Template.TableAddfielddefinition('XX-BEN.CURP'           ,'18'       , 'A', '')
    EB.Template.TableAddoptionsfield   ('XX-BEN.IDENTIFICA'     ,'1_2_3_4_5'   , 'A', '')
    EB.Template.TableAddfielddefinition('XX-BEN.NRO.IDENTI'     ,'25'    , 'A', '')
    EB.Template.TableAddoptionsfield   ('XX-PARENTESCO.BEN'     ,'PADRE_MADRE_HIJO(A)_ABUELO(A)_NIETO(A)_HERMANO(A)_TIO(A)_PRIMO(A)_SOBRINO(A)_ESPOSO(A)_SUEGRO(A)_CU?ADO(A)_AMIGO(A)_COMPADRE/COMADRE_MISMO CLIENTE_EMPRESA RELACIONADA_SOC EMP RELACIONADA', 'A', '')
   
    EB.Template.TableAddfielddefinition('XX-BEN.PAIS.NAC'       ,'9'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("COUNTRY")
    
    EB.Template.TableAddfield          ('XX-BEN.FEC.NAC', EB.Template.T24Date,  '', '')
    
    EB.Template.TableAddfielddefinition('XX-BEN.NACIONAL'       ,'9'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("COUNTRY")
    ...
    EB.Template.TableAddfielddefinition('XX-BEN.ESTADO'         ,'3'        , 'A', '')
    ...
    EB.Template.TableAddfielddefinition('XX-BEN.CIUDAD'         ,'4'        , 'A', '')
    ...
    EB.Template.TableAddfielddefinition('XX>BEN.OCUP.ACT'       ,'3'        , 'A', '')
...
*****************************************************************************
    ...
    EB.Template.TableAddfielddefinition('XX-PER.AUT.PAIS.NA'    ,'9'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("COUNTRY")
    ...
    EB.Template.TableAddfielddefinition('XX-PER.AUT.ESTADO'     ,'3'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.ESTADO")
...
*****************************************************************************
    ...
    EB.Template.TableAddfielddefinition('XX-FACU.ENT.REG'       ,'3'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.ESTADO")
...
*****************************************************************************
    ...
    EB.Template.TableAddfielddefinition('XX-COT.ASIG.INT'       ,'5'        , 'A', '')
    ...
    EB.Template.TableAddoptionsfield   ('XX-PARENTESCO.COT'     ,'PADRE_MADRE_HIJO(A)_ABUELO(A)_NIETO(A)_HERMANO(A)_TIO(A)_PRIMO(A)_SOBRINO(A)_ESPOSO(A)_SUEGRO(A)_CU?ADO(A)_AMIGO(A)_COMPADRE/COMADRE_MISMO CLIENTE_EMPRESA RELACIONADA_SOC EMP RELACIONADA', 'A', '')
    ...
    EB.Template.TableAddfielddefinition('XX-COT.ESTADO'         ,'3'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.ESTADO")
...
*****************************************************************************
    ...
    EB.Template.TableAddfielddefinition('EST.FON.TER'           ,'3'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.ESTADO")
    
    EB.Template.TableAddfielddefinition('DEL.MUN.FON.TER'       ,'5'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.MUNICIPIO")
    
    EB.Template.TableAddfielddefinition('COL.FON.TER'           ,'15'       , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.COLONIA")
    
    EB.Template.TableAddfielddefinition('CIUDAD.FON.TER'        ,'4'        , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.CIUDAD")
...
*****************************************************************************
    ...
    EB.Template.TableAddfielddefinition('GPO.CLUB.AHORRO'       ,'5'        , 'A', '')
    ...
    EB.Template.TableAddfielddefinition('XX-ASIG.INT.COTI'      ,'5'        , 'A', '')
    EB.Template.TableAddoptionsfield   ('XX-PARENTESCO.COTI'    ,'PADRE_MADRE_HIJO(A)_ABUELO(A)_NIETO(A)_HERMANO(A)_TIO(A)_PRIMO(A)_SOBRINO(A)_ESPOSO(A)_SUEGRO(A)_CU?ADO(A)_AMIGO(A)_COMPADRE/COMADRE_MISMO CLIENTE_EMPRESA RELACIONADA_SOC EMP RELACIONADA', 'A', '')
...
*****************************************************************************
    ...
    EB.Template.TableAddfielddefinition('ROL'                   ,'30'       , 'A', '')
    EB.Template.FieldSetcheckfile      ("AA.CUSTOMER.ROLE")
    
    EB.Template.TableAddfield          ('CREATE.DATE', EB.Template.T24Date,  '', '')
    
    EB.Template.TableAddfielddefinition('PRODUCTO'              ,'30'       , 'A', '')
    ...
    EB.Template.TableAddoptionsfield   ('CLASSIFICATION'        ,'1_2_3_4_5_COT'   , 'A', '')
    
    EB.Template.TableAddfielddefinition('ACCOUNT.OFFICER'       ,'20'       , '', '')
    ...
    EB.Template.TableAddfielddefinition('XX.POSTING.RESTRICT'   ,'4'        , '', '')
...
*OTROS
*****************************************************************************
    EB.Template.TableAddfielddefinition('GEOLOCALIZACION'       ,'40'       , 'A', '')
    
    EB.Template.TableAddoptionsfield   ('XX<ALT.ACCT.TYPE'      ,'LEGACY_T24.IBAN_PREV.IBAN_ACCOUNT_CELULAR_PRN_BALANCE.ID'   , 'A', '')
    EB.Template.TableAddfielddefinition('XX>ALT.ACCT.ID'        ,'36'       ,'A', '')

    EB.Template.TableAddfielddefinition('PRN'                   ,'20'       , 'A', '')

    EB.Template.TableAddfielddefinition('CANAL'                 ,'35'       , 'A', '')
    EB.Template.FieldSetcheckfile      ("ABC.CANAL")

    EB.Template.TableAddoptionsfield   ('INT.LIQU.TYPE'  		,'DR_DR1_DR2_CR_CR1_CR2'   , 'A', '')
    EB.Template.TableAddfielddefinition('INT.LIQU.ACCT'			,'16'		, 'A', '')
