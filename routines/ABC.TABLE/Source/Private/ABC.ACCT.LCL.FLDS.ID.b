* @ValidationCode : MjotMTIxODQwNzgxMDpDcDEyNTI6MTc1NTczOTYwNzkxODpMdWlzIENhcHJhOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjI0X1NQMS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 20 Aug 2025 22:26:47
...
*Si envia el numero de cuenta se busca el id de AA.
    ...
    Y.AA = LEFT(Y.ID,2)
    Y.AA.NEW = LEFT(Y.ID,5)

    IF (Y.AA NE 'AA') THEN
        IF (Y.AA.NEW NE 'NEWAC') THEN
