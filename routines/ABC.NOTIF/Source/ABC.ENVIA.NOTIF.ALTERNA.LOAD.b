* @ValidationCode : MjotMTEyMzgxOTQ1MDpDcDEyNTI6MTc3MTk4NTQwNjcyOTpDw6lzYXJNaXJhbmRhOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjI0X1NQMS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 24 Feb 2026 20:10:06
    ...
    IF R.ABC.GENERAL.PARAM THEN
        ...
        FOR Y.AA=1 TO Y.NO.PARAM
            ...
            IF Y.PARAMETRO EQ 'PATH' THEN
                AbcNotif.setYPath(Y.DATOS.PARAMETROS<1,Y.AA>)
                Y.CADENA.LOG<-1> = "YPath->" : Y.DATOS.PARAMETROS<1,Y.AA>
            END
        NEXT Y.AA
...
*********
    ...
    Y.NOMBRE.RUTINA = "ABC.ENVIA.NOTIF.ALTERNA.LOAD"
