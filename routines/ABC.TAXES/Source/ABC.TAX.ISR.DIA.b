* @ValidationCode : MjotMjQxODA3NjU5OkNwMTI1MjoxNzY5MjA5MzY2NzE2OkVkZ2FyIFNhbmNoZXo6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 23 Jan 2026 17:02:46
...
*---------------------------------------------------------------
    ...
    IF NOT(YERROR) THEN
        Y.ARR.ID = R.ACCOUNT<AC.AccountOpening.Account.ArrangementId>
