* @ValidationCode : MjotMTMxNDAyNDEzMzpDcDEyNTI6MTc1NTU2MTQzNTQ2NTpMdWlzIENhcHJhOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjI0X1NQMS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 Aug 2025 20:57:15
...
**********************
    ...
    IF (Y.LISTA.DE.CODIGOS NE '') THEN
        FINDSTR Y.TRANSACTION.CODE IN Y.LISTA.DE.CODIGOS SETTING Y.POS THEN
            ...
            Y.VALOR.LIMITE =  Y.REGISTRO.LIMITE<AbcTable.AbcNivelCuenta.ValorLimite>
        END
    END
...
**********************
    ...
    END ELSE
        ...
        ETEXT = 'EL MONTO DE LA TRANSACCION SUPERA EL LIMITE PERMITIDO. SE PERMITE UN MONTO MAXIMO DE: ':Y.VALOR.LIMITE:' MXN'
        EB.SystemTables.setEtext(ETEXT)
        EB.ErrorProcessing.StoreEndError()
