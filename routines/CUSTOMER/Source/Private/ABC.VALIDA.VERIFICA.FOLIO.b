* @ValidationCode : MjotMTc3OTE5NzE0MjpDcDEyNTI6MTc1NjEzNTY4NDEzMzpMdWNhc0ZlcnJhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 25 Aug 2025 12:28:04
...
*        Y.CLASS.CUST = REC.CUSTO<ST.Customer.Customer.EbCusLocalRef, POS.CLASSIFICATION>
        Y.CLASS.CUST = REC.CUSTO<ST.Customer.Customer.EbCusSector>[1,1]
    END
...
*---------------------------------------------------------------
    ...
    Y.ID.ARRAY = R.ACC.CUS<AC.AccountOpening.Account.ArrangementId>
    ...
    IF R.ABC.ACCT.LCL.FLDS THEN
        Y.NIVEL.CTA = R.ABC.ACCT.LCL.FLDS<AbcTable.AbcAcctLclFlds.Nivel>
    END ELSE
