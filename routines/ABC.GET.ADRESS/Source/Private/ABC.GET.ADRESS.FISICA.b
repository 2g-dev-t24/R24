* @ValidationCode : MjoxNzM1MTAzMjI2OkNwMTI1MjoxNzY5Mzc1ODI1MTIwOkx1aXMgQ2FwcmE6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 25 Jan 2026 18:17:05
...
SUBROUTINE ABC.GET.ADRESS.FISICA
...
*********
    ...
    IF Y.OFS.OPERATION EQ 'VALIDATE' THEN
        RETURN
    END ELSE
...
*CALL ABC.CUS.VAL.LOC(Y.MUNICIPIO)
        ...
        IF NOT(EB.SystemTables.getRNew(ST.Customer.Customer.EbCusSubDepartment)) THEN
            EB.SystemTables.setAf(ST.Customer.Customer.EbCusSubDepartment)
            ETEXT = 'ST-INPUT.MISSING'
            EB.SystemTables.setEtext(ETEXT)
            EB.ErrorProcessing.StoreEndError()
        END
